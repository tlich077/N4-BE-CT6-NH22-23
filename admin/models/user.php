...
class User extends Db{
    ...
    public function Edit($id,$fullname,$username,$password)
    {
        $sql = self::$connection->prepare("UPDATE `users` SET `fullname` =  '$fullname', `username` =  '$username',`password` =  '$password' where id = '$id'" );
